...
public class ShotCalculator {
    ...
    public static Command increaseTurretAngleOffset() {
        return Commands.runOnce(() -> TURRET_ANGLE_OFFSET += 0.5).ignoringDisable(true);
    }
    ...
    public ShootingParameters getParameters() {
        ...
        for (int i = 0; i < 20; i++) {
            double offsetX = turretVelocityX * tofFinal;
            double offsetY = turretVelocityY * tofFinal;
        ...
        double rawOmega = deltaRotTurret / LOOP_PERIOD_SECS;
