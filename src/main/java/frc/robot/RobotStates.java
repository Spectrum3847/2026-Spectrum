...
public class RobotStates {
    ...
    public static final Trigger readyToLaunch =
            RotationalPivotStates.aimingAtTarget().and(LauncherStates.aimingAtTarget());
    ...
    public static final Trigger launchingForLEDS =
            new Trigger(() -> appliedState == State.TURRET_TRACK_WITH_LAUNCH);
    ...
    public static void setupStates() {
        ...
        RotationalPivotStates.aimingAtTarget()
                .onTrue(
                        new InstantCommand(
                                () -> SmartDashboard.putBoolean("TurretOnTarget", true)));
        RotationalPivotStates.aimingAtTarget()
                .onFalse(
                        new InstantCommand(
                                () -> SmartDashboard.putBoolean("TurretOnTarget", false)));
        LauncherStates.aimingAtTarget()
                .onTrue(
                        new InstantCommand(
                                () -> SmartDashboard.putBoolean("LauncherOnTarget", true)));
        LauncherStates.aimingAtTarget()
                .onFalse(
                        new InstantCommand(
                                () -> SmartDashboard.putBoolean("LauncherOnTarget", false)));
