...
public final class RobotStates {
    ...
    public static final Trigger robotReadyScore = (robotInScoreZone).and(movementStable, visionStable, readyToLaunch);

    public static final Trigger robotReadyFeed = (robotInFeedZone).and(hopperFull, movementStable, visionStable, readyToLaunch);
