...
public class RobotSim {
    ...
    //                 Pose3d.kZero.plus(
    //                         new Transform3d(
    //                                 new Translation3d(intakeExtensionPose, 0, 0),
    // Rotation3d.kZero));
    ...
    //                     Translation3d launchVelocity = new Translation3d(launchSpeed,
    // launchRotation);
    ...
    //                             new SequentialCommandGroup(Commands.waitSeconds(Math.random() *
    // 0.3));
