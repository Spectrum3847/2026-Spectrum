...
public class LedStates {
    ...
    public static final Trigger blueShift =
            new Trigger(() -> {return DriverStation.getAlliance().equals(DriverStation.Alliance.Blue);})
                    .and(Util.teleop);
    public static final Trigger redShift =
            new Trigger(() -> {return DriverStation.getAlliance().equals(DriverStation.Alliance.Red);})
                    .and(Util.teleop);
