...
public class SwerveConfig {
    ...
    @Getter
    private final double simLoopPeriod = 0.005; // 5 ms

    @Getter
    @Setter
    private double deadband = 0.05; // 5% input deadband for the joysticks

    @Getter
    @Setter
    private double aimDeadband = 0.01; // 1% input deadband for aiming modes

    @Getter
    @Setter
    private double driveGearRatio = 6.03;

    @Getter
    @Setter
    private double steerGearRatio = 26.09;
    ...
    @Getter
    @Setter
    private LinearVelocity linearSpeedAt12Volts = MetersPerSecond.of(5.12);

    // Theoretical rotational free speed (deg/s) at 12v applied output;
    @Getter
    @Setter
    private AngularVelocity angularSpeedAt12Volts = DegreesPerSecond.of(540.00);

    // -----------------------------------------------------------------------
    // PID Controller Constants
    // -----------------------------------------------------------------------
    @Getter
    private double kPRotationController = 5.0;

    @Getter
    private double kIRotationController = 0.0;

    @Getter
    private double kDRotationController = 0.0;

    /* Blue alliance sees forward as 0 degrees (toward red alliance wall) */
    @Getter
    private final Rotation2d blueAlliancePerspectiveRotation = Rotation2d.kZero;
    ...
    @Getter
    private Slot0Configs steerGains = new Slot0Configs()
            .withKP(500)
            .withKI(0)
            .withKD(20)
            .withKS(0.15)
    ...
    @Getter
    @Setter
    private Current slipCurrent = Amps.of(80);
    ...
    @Getter
    private TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
            .withCurrentLimits(new CurrentLimitsConfigs()
    ...
    @Getter
    private double coupleRatio = 4.5;

    @Getter
    @Setter
    private boolean steerMotorReversed = false;

    @Getter
    @Setter
    private boolean invertLeftSide = false;
    ...
    @Getter
    @Setter
    private CANBus canBus = new CANBus(Rio.CANIVORE, "./logs/spectrum.hoot");
    ...
    @Getter
    private double steerInertia = 0.01;

    @Getter
    private double driveInertia = 0.01;
    // Simulated voltage necessary to overcome friction
    @Getter
    private Voltage steerFrictionVoltage = Volts.of(0.25);

    @Getter
    private Voltage driveFrictionVoltage = Volts.of(0.25);
    ...
    @Getter
    private final double drivebaseRadiusInches = Math.hypot(wheelBaseInches / 2.0, trackWidthInches / 2.0);
    ...
    // Front Left
    @Getter
    private int frontLeftDriveMotorId = 1;

    @Getter
    private int frontLeftSteerMotorId = 2;

    @Getter
    private int frontLeftEncoderId = 3;

    @Getter
    private Angle frontLeftEncoderOffset = Rotations.of(-0.83544921875);

    @Getter
    private boolean frontLeftSteerInverted = false;

    @Getter
    private Distance frontLeftXPos = Inches.of(wheelBaseInches / 2);

    @Getter
    private Distance frontLeftYPos = Inches.of(trackWidthInches / 2);

    // Front Right
    @Getter
    private int frontRightDriveMotorId = 11;

    @Getter
    private int frontRightSteerMotorId = 12;

    @Getter
    private int frontRightEncoderId = 13;

    @Getter
    private Angle frontRightEncoderOffset = Rotations.of(-0.15234375);

    @Getter
    private boolean frontRightSteerInverted = false;

    @Getter
    private Distance frontRightXPos = Inches.of(wheelBaseInches / 2);

    @Getter
    private Distance frontRightYPos = Inches.of(-trackWidthInches / 2);

    // Back Left
    @Getter
    private int backLeftDriveMotorId = 21;

    @Getter
    private int backLeftSteerMotorId = 22;

    @Getter
    private int backLeftEncoderId = 23;

    @Getter
    private Angle backLeftEncoderOffset = Rotations.of(-0.4794921875);

    @Getter
    private boolean backLeftSteerInverted = false;

    @Getter
    private Distance backLeftXPos = Inches.of(-wheelBaseInches / 2);

    @Getter
    private Distance backLeftYPos = Inches.of(trackWidthInches / 2);

    // Back Right
    @Getter
    private int backRightDriveMotorId = 31;

    @Getter
    private int backRightSteerMotorId = 32;

    @Getter
    private int backRightEncoderId = 33;

    @Getter
    private Angle backRightEncoderOffset = Rotations.of(-0.84130859375);

    @Getter
    private boolean backRightSteerInverted = false;

    @Getter
    private Distance backRightXPos = Inches.of(-wheelBaseInches / 2);

    @Getter
    private Distance backRightYPos = Inches.of(-trackWidthInches / 2);
    ...
    public SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>[] getModules() {
