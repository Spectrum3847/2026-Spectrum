...
| `Robot`          | Control flow. Keep it minimal and declarative.                                |
...
Use: `intakeButton.whileTrue(intake.runIntakeCommand(1.0));` or in sequences. **Do not** use it for multi-subsystem commands; it causes circular dependencies.
