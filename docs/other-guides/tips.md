...
*   **How to Clean**: In VS Code, open the Command Palette (`Ctrl + p`) and type `>java Clean` to initiate the cleaning process. This rebuilds the Java language server's cache.
