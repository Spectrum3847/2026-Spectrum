...
* [Loop Time and CPU Handoff 2026-09-05](other-guides/loop-time-handoff-2026-09-05.md) — the saturated-CPU diagnosis, what was cut and why, the pre-existing odometry errors, and how to measure tonight's deploy.
* [Tuning and Calibration Handoff 2026-09-08](other-guides/tuning-calibration-handoff-2026-09-08.md) — where the shot map, operator trims and motor gains are still tuned by hand, and a work list for closing each loop through the robot app.
